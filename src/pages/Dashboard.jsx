...
export default function Dashboard() {
  ...
  return (
    <div className="fixed inset-0 bg-bg text-white flex overflow-hidden">
      <Sidebar />

      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        <DashboardTopbar />

        <main className="flex-1 overflow-y-auto px-6 md:px-10 pt-10 pb-16 max-w-7xl w-full mx-auto">
          <motion.div
